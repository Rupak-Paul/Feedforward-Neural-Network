...
def main():
    sweep_config = {
        ...
        'parameters': {
            ...
            'hiddenLayerSize': {'values': [8, 16, 32, 64]},
            'weightDecay': {'values': [0, 0.0005, 0.5]},
            'learningRate': {'values': [1e-2, 1e-3, 1e-4]},
            'optimizer': {'values':['nesterov', 'sgd', 'adam', 'momentum', 'nadam', 'rmsprop']},
            'batchSize': {'values':[16, 32, 64, 128]},
            'weightInitialisation': {'values':['Xavier', 'random']},
            'activationFunctions': {'values':['sigmoid', 'tanh', 'ReLU']},
            'lossFunction': {'values':['cross entropy']},
            'beta': {'values':[0.5, 0.9]},
            'beta1': {'values':[0.9]},
            'beta2': {'values':[0.999]}
        }
