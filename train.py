...
def main():
    ...
    parser.add_argument("--wandb_project", "-wp", type=str, default="DL_Assignment_Test")
    parser.add_argument("--wandb_entity", "-we", type=str, default="CS23M056")
    ...
    parser.add_argument("--epsilon", "-eps", type=float, default=1e-6)
    parser.add_argument("--weight_decay", "-w_d", type=float, default=0)
    parser.add_argument("--weight_init", "-w_i", type=str, default="Xavier")
    parser.add_argument("--num_layers", "-nhl", type=int, default=1)
    parser.add_argument("--hidden_size", "-sz", type=int, default=10)
    parser.add_argument("--activation", "-a", type=str, default="tanh")

    args = parser.parse_args()

    projectName = args.wandb_project
    entityName = args.wandb_entity
    dataset = args.dataset
    epochs = args.epochs
    hiddenLayers = args.num_layers
    hiddenLayerSize = args.hidden_size
    weightDecay = args.weight_decay
    learningRate = args.learning_rate
    optimizer = args.optimizer
    batchSize = args.batch_size
    weightInitialisation = args.weight_init
    ...
    wandb.init(project=(projectName + entityName))
